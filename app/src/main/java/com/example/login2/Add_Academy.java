...
public class Add_Academy extends AppCompatActivity {
    EditText phoneNo, personeName, academyName, email, location,price;
    Button save;
    ImageView imageView;
    FirebaseDatabase rootNode;
    DatabaseReference referencee = FirebaseDatabase.getInstance().getReference().child("academy");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String txt_academyName=academyName.getText().toString();
                String txt_price=price.getText().toString();
                String txt_email=email.getText().toString();
                if (txt_email.isEmpty() || txt_academyName.isEmpty() || txt_location.isEmpty() ||txt_personName.isEmpty() ||
                        txt_phoneNo.isEmpty() || txt_price.isEmpty())
                {
                    Toast.makeText(Add_Academy.this, "Some Detials Missed", Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(Add_Academy.this, "Your Detials Add Sucessfully", Toast.LENGTH_SHORT).show();
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            fileref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    map.put("academy name", txt_academyName);
